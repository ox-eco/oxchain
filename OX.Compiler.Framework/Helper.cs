...
namespace OX.SmartContract.Framework
{
    public static class Helper
    {
        ...
        /// <summary>
        /// Converts string to byte[]. Examples: "hello" -> [0x68656c6c6f]; "" -> []; "OX" -> [0x4e656f]
        /// </summary>
        [Script]
        public extern static byte[] AsByteArray(this string source);

        /// <summary>
        /// Converts byte[] to string. Examples: [0x68656c6c6f] -> "hello"; [] -> ""; [0x4e656f] -> "OX"
        /// </summary>
        [Script]
        ...
        /// <summary>
        /// Returns a reversed copy of byte[] parameter 'source' (parameter is not affected because byte[] is copy-based on OXVM).
