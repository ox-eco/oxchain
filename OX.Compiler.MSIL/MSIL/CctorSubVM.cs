...
namespace OX.Compiler.MSIL
{
    class CctorSubVM
    {
        ...
        public static void Parse(ILMethod from, OXModule to)
        {
                    ...
                    case CodeEx.Call:
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if (attr.AttributeType.FullName == "OX.SmartContract.Framework.NonemitWithConvertAttribute")
                                    {
                                        ...
                                        {
                                            var bytes = OX.AllianceOfThinWallet.Cryptography.Base58.Decode(text);
