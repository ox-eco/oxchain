...
namespace OX
{
    public static class Helper
    {
        ...
        internal static int OXGetBitLength(this BigInteger i)
        {
        ...
        internal static BigInteger OXNextBigInteger(this Random rand, int sizeInBits)
        {
            if (sizeInBits < 0)
        ...
        internal static BigInteger OXNextBigInteger(this RandomNumberGenerator rng, int sizeInBits)
        {
            if (sizeInBits < 0)
                throw new ArgumentException("sizeInBits must be non-negative");
            if (sizeInBits == 0)
