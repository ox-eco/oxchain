    ...
    internal class ECFieldElement : IComparable<ECFieldElement>, IEquatable<ECFieldElement>
    {
        ...
        public ECFieldElement Sqrt()
        {
            ...
            do
            {
                ...
                do
                {
                    P = rand.OXNextBigInteger(curve.Q.OXGetBitLength());
                }
        ...
        public byte[] ToByteArray()
        {
            ...
            if (data.Length == 32)
                return Enumerable.Reverse(data).ToArray();
            if (data.Length > 32)
                return data.Take(32).Reverse().ToArray();
            return Enumerable.Repeat<byte>(0, 32 - data.Length).Concat(Enumerable.Reverse(data)).ToArray();
        }
