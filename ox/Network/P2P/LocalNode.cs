...
namespace OX.Network.P2P
{
    public class LocalNode : Peer
    {
        ...
        internal static IPEndPoint GetIPEndpointFromHostPort(string hostNameOrAddress, int port)
        {
        ...
        private void OnRelay(IInventory inventory)
        {
            ...
            {
                bool ok = true;
                if (inventory is BizTransaction bt)
                {
                    ok = bt.BizTxState == BizTransactionStatus.OnChain;
                }
                if (ok)
