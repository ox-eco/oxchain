...
namespace OX.Bapps
{
    ...
    public abstract class Bapp
    {
        ...
        IFlashMessageProvider _flashMessageProvider;
        protected IFlashMessageProvider FlashMessageProvider
        {
            get
            {
        ...
        public static IEnumerable<IFlashMessageProvider> AllFlashMessageProviders()
        {
            foreach (var bapp in bapps)
            {
                if (bapp.FlashMessageProvider.IsNotNull())
                {
                    yield return bapp.FlashMessageProvider;
                }
            }
        }
        ...
        void setBappState()
        {
            foreach (var ad in BizScriptHashStates)
            {
                ...
                BizScriptHashStates[pubkey] = Blockchain.Singleton.VerifySlotValidator(sh);
            }
        }
