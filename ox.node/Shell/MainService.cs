...
using ECCurve = OX.Cryptography.ECC.ECCurve;
...
namespace OX.Shell
{
    ...
    {
        private OXSystem system;
        private WalletIndexer indexer;
        private LevelDBStore store;
        protected override string Prompt => "ox";
        public override string ServiceName => "ox node";
            ...
            string contractEmail, string contractDescription, out UInt160 scriptHash)
        {
            ...
            using (ScriptBuilder sb = new ScriptBuilder())
            {
                ...
                sb.EmitSysCall("OX.Contract.Create", script, parameterList, returnType, properties,
        ...
        private bool OnStartCommand(string[] args)
        {
            ...
            {
                case "debug":
                    return OnStartDebugCommand(args);
                case "consensus":
        ...
        private bool OnStopCommand(string[] args)
        {
            ...
            {
                case "debug":
                    return OnStopDebugCommand(args);
                default:
                    return base.OnCommand(args);
            }
        }
        private bool OnStartDebugCommand(string[] args)
        {
            ...
            Console.WriteLine($"level {Debugger.Level} debugger running.");
            return true;

        }
        private bool OnStopDebugCommand(string[] args)
        {
            Debugger.Running = false;
            Console.WriteLine("debugger stopping.");
            return true;
        }
        ...
        private bool OnInstallCommand(string[] args)
        {
            ...
            Console.WriteLine($"Install successful, please restart ox node.");
            return true;
        }
        ...
        private bool OnUnInstallCommand(string[] args)
        {
            ...
            Console.WriteLine($"Uninstall successful, please restart ox node.");
            return true;
        }
