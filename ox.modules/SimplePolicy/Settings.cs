...
namespace OX.Plugins
{
    internal class Settings
    {
        ...
        private Settings(IConfigurationSection section)
        {
            ...
            this.HighPriorityTxType = new EnumSet<TransactionType>(section.GetSection("HighPriorityTxType"), TransactionType.ClaimTransaction, TransactionType.BillTransaction,TransactionType.CharitableTransaction, TransactionType.GovementTransaction);
